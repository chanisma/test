...
var character = [
		...
		{class: '수영복', name: '지무유', attr: quarantine, weapon: pistol, tactic: onset, guide: guide_dir + 'chara-67', appear: on, rarity: 3, picture: picture_dir + '067.jpg', rank: 4, selected : 1, cookie : 0,		quick: 3, quick_s: 0, dmg: 4, survival: 0},
	...
	add_character('치파오', '지무유', quarantine, shotgun, onset, guide_dir + 'chara-103', on, 4, picture_dir + '103.jpg', 1, 1, 0,		3, 1, 3, 5);
	...
	add_character('치파오', '문', spirit, assault, support, guide_dir + 'chara-100', on, 4, picture_dir + '100.jpg', 3, 1, 0,				4, 3, 3, 0);
	...
	add_character('치파오', '지무카', erode, pistol, defense, guide_dir + 'chara-102', on, 4, picture_dir + '102.jpg', 3, 1, 0,			4, 0, 4, 5);
	...
	add_character('수영복', '주노', quarantine, assault, power, guide_dir + 'chara-69', on, 4, picture_dir + '069.jpg', 3, 1, 0,		5, 0, 4, 0);
	...
	add_character('수영복', '이코스', quarantine, heavy, support, guide_dir + 'chara-68', on, 4, picture_dir + '068.jpg', 5, 1, 0,		0, 4, 0, 0);
	...
	add_character('수영복', '문', quarantine, pistol, defense, guide_dir + 'chara-71', on, 3, picture_dir + '071.jpg', 3, 1, 0,			0, 0, 0, 2);
	...
	add_character('수영복', '소쇼우신', quarantine, shotgun, support, guide_dir + 'chara-70', on, 3, picture_dir + '070.jpg', 4, 1, 0,	5, 4, 5, 0);
