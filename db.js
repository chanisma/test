...
var character = [
		...
		{class: '전술장비', name: '아이린', attr: machine, weapon: pistol, tactic: power, guide: guide_dir + 'chara-2', appear: on, rarity: star4, picture: picture_dir + '002.jpg', rank: 3, selected : 1},
		...
		{class: '메이드복', name: '지무유', attr: spirit, weapon: pistol, tactic: power, guide: guide_dir + 'chara-6', appear: on, rarity: star4, picture: picture_dir + '006.jpg', rank: 3, selected : 1},
		{class: '메이드복', name: '소쇼우신', attr: machine, weapon: shotgun, tactic: support, guide: guide_dir + 'chara-5', appear: on, rarity: star4, picture: picture_dir + '005.jpg', rank: 3, selected : 1},
		...
		{class: '메이드복', name: '아이린', attr: quarantine, weapon: heavy, tactic: onset, guide: guide_dir + 'chara-18', appear: on, rarity: star3, picture: picture_dir + '018.jpg', rank: 3, selected : 1},
		...
		{class: '메이드복', name: '유키', attr: quarantine, weapon: shotgun, tactic: support, guide: guide_dir + 'chara-17', appear: on, rarity: star3, picture: picture_dir + '017.jpg', rank: 3, selected : 1},
		{class: '메이드복', name: '코넬리아', attr: machine, weapon: assault, tactic: power, guide: guide_dir + 'chara-8', appear: on, rarity: star3, picture: picture_dir + '008.jpg', rank: 3, selected : 1},
		{class: '메이드복', name: '리타', attr: life, weapon: sniper, tactic: support, guide: guide_dir + 'chara-20', appear: on, rarity: star3, picture: picture_dir + '020.jpg', rank: 3, selected : 1},
		...
		{class: '사복', name: '이코스', attr: machine, weapon: heavy, tactic: power, guide: guide_dir + 'chara-16', appear: on, rarity: star3, picture: picture_dir + '016.jpg', rank: 3, selected : 1},
		...
		{class: '사복', name: '주노', attr: quarantine, weapon: sniper, tactic: onset, guide: guide_dir + 'chara-24', appear: on, rarity: star3, picture: picture_dir + '024.jpg', rank: 3, selected : 1},
		...
		{class: '전술장비', name: '리타', attr: machine, weapon: shotgun, tactic: onset, guide: guide_dir + 'chara-64', appear: on, rarity: star3, picture: picture_dir + '064.jpg', rank: 3, selected : 1},
		...
		{class: '서약', name: '코넬리아', attr: machine, weapon: shotgun, tactic: power, guide: guide_dir + 'chara-075', appear: on, rarity: star3, picture: picture_dir + '075.jpg', rank: 3, selected : 1},
